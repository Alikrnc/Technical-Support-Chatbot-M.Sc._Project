...
public class Phone extends Product {
    public Phone(String productTrackingNo, String productType, String partType, String damageType, String warrantyStartDate, String warrantyEndDate, 
    ...
    public double calculateServiceFee() {
        ...
        return 30.0; // Non-warranty service fee for Phone 
    }
}
