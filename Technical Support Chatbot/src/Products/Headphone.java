...
public class Headphone extends Product {
    public Headphone(String productTrackingNo, String productType, String partType, String damageType, String warrantyStartDate, String warrantyEndDate, 
    ...
    public double calculateServiceFee() {
        ...
        return 50.0; // Non-warranty service fee for Headphone
    }
}
